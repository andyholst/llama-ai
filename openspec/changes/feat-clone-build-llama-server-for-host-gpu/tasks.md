...
- [x] 4. Tests: Darwin-arm64 → Metal flags not CUDA; nvidia-smi → CUDA flags not Metal; neither → CPU cmake (Metal/CUDA off); binary present → no cmake; dry download → no clone/cmake.
